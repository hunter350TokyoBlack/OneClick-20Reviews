...
The {{businessName}} Team`
  ...
  const addManualContact = () => {
    if (!manualContact.firstName || !manualContact.lastName || (!manualContact.email && !manualContact.phone)) {
      return;
    }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Set up a review request campaign to send to your customers</p>
        </div>

        {/* Progress Steps */}
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center space-x-4">
            <div className={`flex items-center space-x-2 ${activeTab === "details" ? "text-indigo-600" : "text-gray-400"}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${activeTab === "details" ? "bg-indigo-600 text-white" : "bg-gray-200"}`}>
                1
              </div>
              <span className="font-medium">Campaign Details</span>
            </div>
            <div className="w-8 h-px bg-gray-300"></div>
            <div className={`flex items-center space-x-2 ${activeTab === "contacts" ? "text-indigo-600" : "text-gray-400"}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${activeTab === "contacts" ? "bg-indigo-600 text-white" : "bg-gray-200"}`}>
                2
              </div>
              <span className="font-medium">Add Contacts</span>
            </div>
            <div className="w-8 h-px bg-gray-300"></div>
            <div className={`flex items-center space-x-2 ${activeTab === "review" ? "text-indigo-600" : "text-gray-400"}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${activeTab === "review" ? "bg-indigo-600 text-white" : "bg-gray-200"}`}>
                3
              </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        const template = campaignData.type === "email" ? defaultTemplates.email : defaultTemplates.sms;
                  ...
                  <div className="text-sm text-gray-500">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {["{{firstName}}", "{{lastName}}", "{{businessName}}", "{{link}}"].map(placeholder => (
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <Button
                    ...
                    disabled={!manualContact.firstName || !manualContact.lastName || (!manualContact.email && !manualContact.phone)}
                    className="mt-4"
                  >
                    Add Contact
                  </Button>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        {campaignData.type === "sms" && <Phone className="w-4 h-4" />}
                        {campaignData.type === "email" && <Mail className="w-4 h-4" />}
                        ...
                        <span className="capitalize">{campaignData.type === "both" ? "SMS + Email" : campaignData.type}</span>
                      </div>
                    </div>
                    <div>
                      <Label className="text-sm font-medium text-gray-700">Contacts</Label>
                      <p className="text-gray-900">{contacts.length} recipients</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="bg-gray-50 p-3 rounded-lg text-sm">
                        {campaignData.message.replace(/\{\{firstName\}\}/g, "John")
                          .replace(/\{\{lastName\}\}/g, "Doe")
                          .replace(/\{\{businessName\}\}/g, "Your Business")
                          .replace(/\{\{link\}\}/g, "https://oneclick.reviews/r/abc123")}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  >
                    {isLoading ? "Creating Campaign..." : "Create & Send Campaign"}
                  </Button>
                </div>
              </CardContent>
            </Card>
